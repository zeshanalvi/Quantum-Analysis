...
# Outputs per metric: Excel + PNG plots, each in its own folder.
# Carbon uses ONLY performance runtimes (per your constraint).
...
# Carbon visuals (your requested format)
...
# ---------------------------
# Benchmark driver (+ optional multiprocessing)
# ---------------------------
