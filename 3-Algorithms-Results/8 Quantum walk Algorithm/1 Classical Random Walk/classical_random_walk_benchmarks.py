...
Master-level script producing:
  1) Performance     – runtime, peak memory, accuracy (TV distance to exact)
  2) Scalability     – runtime vs size, memory vs size
  3) Reliability     – success rate (TV <= tol), dispersion across seeds
...
# ========================= Monte Carlo sampler (empirical dist) =========================
