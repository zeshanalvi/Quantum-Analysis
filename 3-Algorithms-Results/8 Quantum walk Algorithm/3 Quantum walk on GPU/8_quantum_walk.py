...
# -*- coding: utf-8 -*-
"""
GPU-accelerated Empirical Evaluation: Quantum Walk 1D (Noiseless) – Quantum Baseline
...
It produces four benchmarks:
  1) Performance     – runtime, memory, accuracy (TV distance vs dense-unitary reference)
...
def run_quantum_walk_experiment():
    ...
    print(f"🚀 Starting Quantum Walk experiments on {get_device_name()}")
    ...
    def _consume(row):
        ...
        all_rows.append(row)
        print(f"  ✅ N={row['n']}, seed={row['seed']} (runtime={row['runtime_s']:.6f}s, TV={row['tv_distance']:.2e}, correct={row['correct']})")
    ...
    # Final summary
    print("\n" + "="*60)
    print("🎉 QUANTUM WALK EXPERIMENT COMPLETE - RESULTS SUMMARY")
    print("="*60)
    ...
    print(f"🔬 Lattice sizes:   {sorted(perf_df['n'].unique())}")
    print(f"🎯 Success rate:    {perf_df['correct'].mean() * 100:.1f}%")
    print(f"📏 Mean TV distance: {perf_df['tv_distance'].mean():.2e}")
...
if __name__ == "__main__":
    ...
    print("🚀 Starting Quantum Walk Benchmark on Kaggle")
    print("=" * 50)
    ...
    if results_df is not None:
        ...
        print("\n✅ All Quantum Walk deliverables generated successfully!")
        ...
        print("❌ Quantum Walk benchmark failed - no results generated")
