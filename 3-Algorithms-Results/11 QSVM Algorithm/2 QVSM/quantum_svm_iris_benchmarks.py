...
# -*- coding: utf-8 -*-
"""
Quantum SVM (QSVM) on Iris — Ideal/Noiseless, version-proof hinge loss

Same framework as classical SVM:
  Folders: Performance/, Scalability/, Reliability/, Carbon footprints/<outdir>/
  Metrics: runtime_s, peak_mem_mb, accuracy, hinge_loss, success (acc ≥ acc_tol)
  Carbon: uses Performance runtime only (never scalability/reliability)

CLI matches the classical script.
"""
