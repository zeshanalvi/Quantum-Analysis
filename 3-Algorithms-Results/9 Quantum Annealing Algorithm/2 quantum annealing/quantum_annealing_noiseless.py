...
Master-level empirical benchmark with the SAME metrics & outputs as your classical SA.

Produces four folders:
...
We round sign(m_{i,z}) at the end to obtain a final bitstring and measure optimality gap.

Default CLI mirrors your classical annealing script.
"""
