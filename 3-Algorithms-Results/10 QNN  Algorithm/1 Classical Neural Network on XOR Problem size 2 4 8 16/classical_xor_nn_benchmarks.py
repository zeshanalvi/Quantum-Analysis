...
# -*- coding: utf-8 -*-
"""
Classical Neural Network for XOR — Master-level Benchmarks
...
Benchmarks produced:
  1) Performance     – runtime, peak memory, final accuracy/loss
  2) Scalability     – runtime (log–log) vs hidden size H, memory vs H
  3) Reliability     – success rate (accuracy ≥ acc_tol), accuracy dispersion
